...
//       setLoggedInUser(decoded); // Set the logged-in user
//     } catch (error) {
...
//       if (!usernames[newMessage.userId]) {
...
//     };
//   }, [groupId, navigate, usernames]);

//   // Fetch usernames for all messages on component mount
//   useEffect(() => {
